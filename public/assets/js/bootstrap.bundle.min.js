...
!(function(t, e) {
        ...
        ? (function(t, e, i) {
            return function n(s) {
              ...
              for (let { target: r } = s; r && r !== this; r = r.parentNode)
                for (const a of o)
                  if (a === r)
                    return M(s, { delegateTarget: r }), n.oneOff &&
                      P.off(t, s.type, e, i), i.apply(r, [s]);
            };
          })(t, i, r)
        : (function(t, e) {
            return function i(n) {
              return M(n, { delegateTarget: t }), i.oneOff &&
  ...
  class rt extends W {
    constructor(t, e) {
      super(
        t,
        e
      ), (this._interval = null), (this._activeElement = null), (this._isSliding = !1), (this.touchTimeout = null), (this._swipeHelper = null), (this._indicatorsElement = z.findOne(".carousel-indicators", this._element)), this._addEventListeners(), this._config.ride === et && this.cycle();
    }
    static get Default() {
      return st;
    }
    ...
    _addEventListeners() {
      this._config.keyboard &&
        P.on(this._element, "keydown.bs.carousel", t =>
          this._keydown(t)
        ), "hover" === this._config.pause && (P.on(this._element, "mouseenter.bs.carousel", () => this.pause()), P.on(this._element, "mouseleave.bs.carousel", () => this._maybeEnableCycle())), this._config.touch && Y.isSupported() && this._addTouchEventListeners();
    }
    ...
    _slide(t, e = null) {
      ...
      s.classList.add(
        ...
        () => {
          s.classList.remove(l, c), s.classList.add(it), i.classList.remove(
            it,
            c,
            l
  ...
  class ft extends W {
    ...
    show() {
      ...
      this._element.classList.remove(
        lt
      ), this._element.classList.add(ct), (this._element.style[e] = 0), this._addAriaAndCollapsedClass(this._triggerArray, !0), (this._isTransitioning = !0);
      const i = `scroll${e[0].toUpperCase() + e.slice(1)}`;
      this._queueCallback(
        () => {
          (this._isTransitioning = !1), this._element.classList.remove(
            ct
          ), this._element.classList.add(lt, at), (this._element.style[e] =
    ...
    hide() {
      ...
      (this._element.style[t] = `${this._element.getBoundingClientRect()[
        t
      ]}px`), d(this._element), this._element.classList.add(ct), this._element.classList.remove(lt, at);
      ...
      (this._isTransitioning = !0), (this._element.style[t] = ""), this._queueCallback(
        () => {
          (this._isTransitioning = !1), this._element.classList.remove(
            ct
          ), this._element.classList.add(lt), P.trigger(
            this._element,
            "hidden.bs.collapse"
          );
        },
  ...
  function ee(t) {
    return ((Wt(t) ? t.ownerDocument : t.document) ||
  ...
  function ue(t) {
    ...
    if (c) {
      ...
      A === $t(i) &&
        ...
        "absolute" === a &&
        ((E = "scrollHeight"), (T = "scrollWidth")), (s === pt ||
        ((s === _t || s === gt) && o === wt)) &&
        (
          (y = mt),
          (m -=
        ...
        var s =
          ...
          a = o.reduce(function(e, i) {
            ...
            return (e.top = Vt(
              s.top,
              e.top
            )), (e.right = Kt(s.right, e.right)), (e.bottom = Kt(s.bottom, e.bottom)), (e.left = Vt(s.left, e.left)), e;
          }, Oe(t, r, n));
        ...
        h = {
          ...
          setOptions: function(i) {
            ...
            d(), (a.options = Object.assign(
              ...
              reference: Wt(t)
                ? Te(t)
                : t.contextElement ? Te(t.contextElement) : [],
              popper: Te(e)
            });
            var r,
              c,
  ...
  class ci extends W {
    constructor(t, e) {
      super(
        t,
        e
      ), (this._popper = null), (this._parent = this._element.parentNode), (this._menu = z.next(this._element, ti)[0] || z.prev(this._element, ti)[0] || z.findOne(ti, this._parent)), (this._inNavbar = this._detectNavbar());
    }
    static get Default() {
      return ai;
    }
    ...
    show() {
      ...
      if (!P.trigger(this._element, "show.bs.dropdown", t).defaultPrevented) {
        ...
        this._element.focus(), this._element.setAttribute(
          "aria-expanded",
          !0
        ), this._menu.classList.add(Ge), this._element.classList.add(
          Ge
    ...
    _completeHide(t) {
      if (!P.trigger(this._element, "hide.bs.dropdown", t).defaultPrevented) {
        ...
        this._popper && this._popper.destroy(), this._menu.classList.remove(
          ...
          "aria-expanded",
          "false"
        ), H.removeDataAttribute(this._menu, "popper"), P.trigger(
          this._element,
          "hidden.bs.dropdown",
          t
        );
  ...
  P.on(
    ...
    Ue,
    Je,
    ci.dataApiKeydownHandler
  ), P.on(document, Ue, ti, ci.dataApiKeydownHandler), P.on(document, Ye, ci.clearMenus), P.on(document, "keyup.bs.dropdown.data-api", ci.clearMenus), P.on(
    document,
    Ye,
    Je,
    function(t) {
  ...
  class pi extends $ {
    ...
    show(t) {
      ...
      this._config.isAnimated &&
        d(e), e.classList.add(hi), this._emulateAnimation(() => {
        g(t);
      });
    }
    hide(t) {
  ...
  class Ti {
    ...
    reset() {
      this._resetElementAttributes(
        this._element,
        "overflow"
      ), this._resetElementAttributes(this._element, Ai), this._resetElementAttributes(yi, Ai), this._resetElementAttributes(wi, Ei);
    }
    isOverflowing() {
  ...
  class Ni extends W {
    constructor(t, e) {
      super(
        t,
        e
      ), (this._dialog = z.findOne(".modal-dialog", this._element)), (this._backdrop = this._initializeBackDrop()), (this._focustrap = this._initializeFocusTrap()), (this._isShown = !1), (this._isTransitioning = !1), (this._scrollBar = new Ti()), this._addEventListeners();
    }
    static get Default() {
      return Di;
    }
    ...
    dispose() {
      P.off(
        window,
        Ci
      ), P.off(this._dialog, Ci), this._backdrop.dispose(), this._focustrap.deactivate(), super.dispose();
    }
    handleUpdate() {
      this._adjustDialog();
    }
          ...
          this._queueCallback(
            () => {
              (this._config.scroll && !this._config.backdrop) ||
                ...
                Pi
              ), this._element.classList.remove(Mi), P.trigger(
                this._element,
                "shown.bs.offcanvas",
                { relatedTarget: t }
              );
            ...
            this._queueCallback(
              () => {
                this._element.classList.remove(
                  ...
                  new Ti().reset(), P.trigger(this._element, $i);
              },
              this._element,
              !0
            )
  ...
  class ln extends W {
    ...
    dispose() {
      clearTimeout(
        this._timeout
      ), P.off(this._element.closest(tn), en, this._hideModalHandler), this._element.getAttribute("data-bs-original-title") && this._element.setAttribute("title", this._element.getAttribute("data-bs-original-title")), this._disposePopper(), super.dispose();
    }
    show() {
    ...
    _createTipElement(t) {
      ...
      return e.setAttribute(
        "id",
        i
      ), this._isAnimated() && e.classList.add(Ji), e;
    }
    setContent(t) {
  ...
  class xn extends W {
    ...
    _toggleDropDown(t, e) {
      ...
      n(
        ".dropdown-toggle",
        An
      ), n(".dropdown-menu", Tn), i.setAttribute("aria-expanded", e);
    }
  ...
  P.on(document, "click.bs.tab", Cn, function(t) {
    ["A", "AREA"].includes(this.tagName) &&
      t.preventDefault(), l(this) || xn.getOrCreateInstance(this).show();
      ...
      this.isShown() &&
        (P.trigger(this._element, "hide.bs.toast").defaultPrevented ||
          (
            ...
            this._queueCallback(
              () => {
                this._element.classList.add(kn), this._element.classList.remove(
                  Sn,
                  Ln
  ...
  return R(
    Nn
  ), m(Nn), { Alert: q, Button: K, Carousel: rt, Collapse: ft, Dropdown: ci, Modal: Ni, Offcanvas: zi, Popover: dn, ScrollSpy: _n, Tab: xn, Toast: Nn, Tooltip: ln };
});
