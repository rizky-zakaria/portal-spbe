...
@section('konten')
    ...
    <div class="container-information d-flex justify-content-center mt-5">
        <div class="row">
            <h3 style="font-family: 'Montserrat', sans-serif">Capaian Kematangan SPBE</h3>
        </div>
    </div>
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane"
                    type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Capaian</button>
            </li>
        </ul>
